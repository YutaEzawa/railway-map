...
const SECTION_OVERRIDES = {
  ...
  // 東海道線の中間・末端区間。
  // 湘南新宿ライン: 大宮から南行（新宿・横浜方面）を数える。
  湘南新宿ライン: { station: '大宮', toward: '横浜' },
  '東海道線(東京〜横浜)': { toward: '横浜' },
  '東海道線(横浜〜大船)': { toward: '大船' },
  '東海道線(大船〜小田原)': { station: '平塚', toward: '小田原' },
  '東海道線(小田原〜熱海)': { station: '小田原', toward: '熱海' },
  // 総武本線の中間区間。
